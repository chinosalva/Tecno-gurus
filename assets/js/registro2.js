...
function validarRegistro(valor1, valor2, valor3, valor4){
    ...
    if (validacion01 == true && (validacion02 == true) && validacion03 == true && (validacion04 == true && tamValor4 === 10)){ 
        ...
        $alertaContrasena.style.color = "red";
        /*alert ("no ok");*/
        ...
        $alertaNombreIcono.innerHTML = ' <i class="bi bi-exclamation-circle-fill"></i>';
    }else if(validacion04 == false || tamValor4!==10){
        $alertaTelefono.style.color = "red";
        $alertaTelIcono.innerHTML = ' <i class="bi bi-exclamation-circle-fill"></i>';
    }else if(validacion01 == false){
        $alertaEmail.style.color = "red";
        $alertaEmailIcono.innerHTML = ' <i class="bi bi-exclamation-circle-fill"></i>';
    }else {
        alert("Revisa datos");
    }
